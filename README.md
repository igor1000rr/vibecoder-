...
👉 **Если ты только что сделал `git pull` и хочешь протестировать — см. [SETUP.md](SETUP.md).**
...
- ✅ Хранение API-ключей через системный OS keychain (SecretStorage)
...
.vibecoder/mcp.example.json           ← пример конфига MCP-серверов
```
